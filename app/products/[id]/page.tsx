...
// Client component for quantity dropdown and AddToCartButton
import { useState } from "react";
function AddToCartWithQuantity({ id, name, price, images, stock }: { id: string; name: string; price: number; images: string[]; stock: number }) {
